...
execute as @s if score @s ha_temp matches 1.. run function horse-armor-enchantments:uninstall/loop_give
...
# remove scoreboards if done
execute as @s if score @s ha_count matches 1.. run return fail
